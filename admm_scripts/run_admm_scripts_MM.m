%% run_admm_scripts_MM.m
% (05/13/2014)
%=========================================================================%
% - run admm scripts on full data: FC + sMRI (no CV procedure)
%=========================================================================%
%%
clear
purge
...
% penalty = 'flas';
penalty = 'isoTV';
options.lambda=2^-13.0; % L1 penalty weight
options.gamma =2^-7.0; % second penalty weight
