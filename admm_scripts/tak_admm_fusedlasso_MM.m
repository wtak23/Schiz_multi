function output=tak_admm_fusedlasso_MM(X,y,options,K)
% output=tak_admm_fusedlasso_MM(X,y,options,K)
% (05/13/2014)
%=========================================================================%
...
for k=1:maxiter
    ...
    v3a=Cv4a-u3a;
    v3b=Cv4b-u3b;
    v3a(b1)=soft(v3a(b1),gamma/rho);  
    v3b(b2)=soft(v3b(b2),gamma/rho);  
%     v3=[v3a;v3b];
