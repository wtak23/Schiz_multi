...
% set(gcf,'Units','pixels','Position', [1+1920/2 1 1920/2 1080/2])
% set(gcf,'Units','pixels','Position', [1+1920/2 1 950 432])
...
elseif strcmpi(host,'takanori.eecs.umich.edu')
    ...
    offy=90;
    tak_imset2(gcf,1921+1440/2,offy,1440/2,(860-offy)/2.15) % hp2760p
else
    set(gcf,'Units','pixels','Position', [1+1920/2 41 950 440]) % for my windows7 lab computer
end
