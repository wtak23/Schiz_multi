function accuracy = tak_get_acc(ypred, ytrue)
% summary = tak_get_acc(ypred, ytrue,option)
% - report accuracy
% (same as tak_binary_classification_accuracy.m, but with shorter function name)
%-------------------------------------------------------------------------%
% (02/23/2014)
%%
