function varargout = tak_gui_show_slices_cor(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @tak_gui_show_slices_cor_OpeningFcn, ...
                   'gui_OutputFcn',  @tak_gui_show_slices_cor_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before tak_gui_show_slices_cor is made visible.
function tak_gui_show_slices_cor_OpeningFcn(hObject, eventdata, handles, varargin)
% Choose default command line output for tak_gui_show_slices_cor
...
% % %     data.spacing3_big   = varargin{3}(2)/data.sizes(1);
    data.spacing2_small = varargin{3}(1)/data.sizes(2);
    data.spacing2_big   = varargin{3}(2)/data.sizes(2);
...
% UIWAIT makes tak_gui_show_slices_cor wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = tak_gui_show_slices_cor_OutputFcn(hObject, eventdata, handles) 
