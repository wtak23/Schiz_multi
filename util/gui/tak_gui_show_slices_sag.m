function varargout = tak_gui_show_slices_sag(varargin)
...
%  varargin{3} = slider spacing setting (#s of index to slide) = [smallx bigx].
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @tak_gui_show_slices_sag_OpeningFcn, ...
                   'gui_OutputFcn',  @tak_gui_show_slices_sag_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before tak_gui_show_slices_sag is made visible.
function tak_gui_show_slices_sag_OpeningFcn(hObject, eventdata, handles, varargin)
% Choose default command line output for tak_gui_show_slices_sag
...
% UIWAIT makes tak_gui_show_slices_sag wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = tak_gui_show_slices_sag_OutputFcn(hObject, eventdata, handles) 
