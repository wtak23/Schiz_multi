function [B,Bdim]=tak_circmask_6d_newcirc(ARRAYSIZE)
% [B,Bdim]=tak_circmask_6d_newcirc(ARRAYSIZE)
%----------------------------------------------------------------------------------
% Create diagonal binary masking matrix B, which masks the "wrap-around" artifacts 
% from using the circulant difference matrix created from tak_diffmat_6d_ver2(ARRAYSIZE,1)
%----------------------------------------------------------------------------------
...
%==================================================================================
maskX1=tak_circmask_1d_newcirc(X1);
maskY1=tak_circmask_1d_newcirc(Y1);
maskZ1=tak_circmask_1d_newcirc(Z1);
maskX2=tak_circmask_1d_newcirc(X2);
maskY2=tak_circmask_1d_newcirc(Y2);
maskZ2=tak_circmask_1d_newcirc(Z2);
