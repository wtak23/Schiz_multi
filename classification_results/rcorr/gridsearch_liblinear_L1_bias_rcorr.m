%% gridsearch_liblinear_L1_bias_rcorr.m
% (05/10/2014)
%=========================================================================%
...
if flag_scale
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear_bias_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear_bias.mat'];
end
