%% gridsearch_NB_PCA_rcorr.m
% (05/12/2014)
%=========================================================================%
% - Try Naive-Bayes method on FC dataset using PC loadings
%-------------------------------------------------------------------------%
% - gridsearch over # PCs
...
fsave=true;
%% load data
load rcorr_design_censor.mat y

% scale to 0 mean, unit variance?
flag_scale = false;
if flag_scale
    load([get_rootdir,'/data_local/rcorr_info/PCA.mat'],'X')
else
    load([get_rootdir,'/data_local/rcorr_info/PCA_zscaled.mat'],'X')
end
...
if flag_scale
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_NB_PCA_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_NB_PCA.mat'];
end
