%% gridsearch_LDA_PCA_plotResults_rcorr
% (05/12/2014)
%=========================================================================%
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_LDA_PCA_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/rcorr/results/gridsearch_LDA_PCA_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_LDA_PCA.mat'];
    outFig=[get_rootdir,'/classification_results/rcorr/results/gridsearch_LDA_PCA'];
end
