%% gridsearch_liblinear_L1_plotResults_rcorr
% (05/12/2014)
%=========================================================================%
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear.mat'];
    outFig=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear'];
end
