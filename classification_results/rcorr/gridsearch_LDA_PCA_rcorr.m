%% gridsearch_LDA_PCA_rcorr.m
% (05/12/2014)
%=========================================================================%
% - Try LDA method on FC dataset using PC loadings
%-------------------------------------------------------------------------%
% - gridsearch over # PCs
...
if flag_scale
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_LDA_PCA_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_LDA_PCA.mat'];
end
