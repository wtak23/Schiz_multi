%% gridsearch_liblinear_L1_rcorr.m
% (05/12/2014)
%=========================================================================%
...
if flag_scale
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_liblinear.mat'];
end
