...
if flag_scale
    X=zscore(X);
    load([get_rootdir,'/data_local/rcorr_info/ttest_rank_idx_CV_zscaled.mat'],...
        'ttest_rank_idx_CV')
else
    load([get_rootdir,'/data_local/rcorr_info/ttest_rank_idx_CV.mat'],...
        'ttest_rank_idx_CV')
end
...
if flag_scale
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_NB_ttest_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/rcorr/results/gridsearch_NB_ttest.mat'];
end
