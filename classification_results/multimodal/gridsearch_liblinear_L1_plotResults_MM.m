%% gridsearch_liblinear_L1_plotResults_MM.m
% (05/12/2014)
%=========================================================================%
% - plot results from gridsearch_liblinear_L1.m
%=========================================================================%
%%
clear
purge
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_liblinear_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/multimodal/results/gridsearch_liblinear_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_liblinear.mat'];
    outFig=[get_rootdir,'/classification_results/multimodal/results/gridsearch_liblinear'];
end
