%% gridsearch_liblinear_L2_ttest_MM.m
% (05/12/2014)
%=========================================================================%
% - Try L2-penalized SVM from liblinear + ttest pruningon FC dataset
%-------------------------------------------------------------------------%
...
if flag_scale
    outPath=[get_rootdir,'/classification_results/multimodal',...
