%% gridsearch_LDA_PCA_plotResults_MM
% (05/12/2014)
%=========================================================================%
% - plot results from gridsearch_LDA_PCA.m
%=========================================================================%
%%
clear
purge
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_LDA_PCA_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/multimodal/results/gridsearch_LDA_PCA_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_LDA_PCA.mat'];
    outFig=[get_rootdir,'/classification_results/multimodal/results/gridsearch_LDA_PCA'];
end
