...
if flag_scale
    outPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_liblinear_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_liblinear.mat'];
end
