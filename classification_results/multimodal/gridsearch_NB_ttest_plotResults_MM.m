%% gridsearch_NB_ttest_plotResults_MM
% (05/12/2014)
%=========================================================================%
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_ttest_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_ttest_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_ttest.mat'];
    outFig=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_ttest'];
end
