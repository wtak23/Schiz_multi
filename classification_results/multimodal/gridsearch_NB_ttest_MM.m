%% gridsearch_NB_ttest_MM.m
% (05/12/2014)
%=========================================================================%
% - Try naive-bayes LDA method on FC+sMRI dataset
%-------------------------------------------------------------------------%
...
if flag_scale
    X=zscore(X);
    load([get_rootdir,'/data_local/multimodal/ttest_rank_idx_CV_zscaled.mat'],...
        'ttest_rank_idx_CV')
else
    load([get_rootdir,'/data_local/multimodal/ttest_rank_idx_CV.mat'],...
        'ttest_rank_idx_CV')
end
...
if flag_scale
    outPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_ttest_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_ttest.mat'];
end
