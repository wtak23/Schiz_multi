...
if flag_scale
    outPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_PCA_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/multimodal/results/gridsearch_NB_PCA.mat'];
end
