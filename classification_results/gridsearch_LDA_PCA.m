...
if flag_scale
    outPath=[get_rootdir,'/classification_results/gridsearch_LDA_PCA_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/gridsearch_LDA_PCA.mat'];
end
