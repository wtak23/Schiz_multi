...
if flag_scale
    outPath=[get_rootdir,'/classification_results/gridsearch_liblinear_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/gridsearch_liblinear2.mat'];
end
