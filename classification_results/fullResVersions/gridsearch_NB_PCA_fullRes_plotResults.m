%% gridsearch_NB_PCA_fullRes_plotResults
% (05/10/2014)
%=========================================================================%
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_NB_PCA_zscaled_fullRes.mat'];
    outFig=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_NB_PCA_zscaled_fullRes'];
else
    dataPath=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_NB_PCA_fullRes.mat'];
    outFig=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_NB_PCA_fullRes'];
end
