%% gridsearch_liblinear_L1_plotResults_fullRes
% (05/10/2014)
%=========================================================================%
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_liblinear_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_liblinear_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_liblinear.mat'];
    outFig=[get_rootdir,'/classification_results/fullResVersions',...
        '/results/gridsearch_liblinear'];
end
