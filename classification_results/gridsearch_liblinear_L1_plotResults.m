%% gridsearch_liblinear_L1_bias_plotResults
% (05/10/2014)
%=========================================================================%
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/results/gridsearch_liblinear_bias_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/results/gridsearch_liblinear_bias_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/results/gridsearch_liblinear_bias.mat'];
    outFig=[get_rootdir,'/classification_results/results/gridsearch_liblinear_bias'];
end
