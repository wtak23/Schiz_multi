%% gridsearch_LDA_PCA_plotResults
% (05/10/2014)
%=========================================================================%
...
if flag_scale
    dataPath=[get_rootdir,'/classification_results/gridsearch_LDA_PCA_zscaled.mat'];
    outFig=[get_rootdir,'/classification_results/gridsearch_LDA_PCA_zscaled'];
else
    dataPath=[get_rootdir,'/classification_results/gridsearch_LDA_PCA.mat'];
    outFig=[get_rootdir,'/classification_results/gridsearch_LDA_PCA'];
end
