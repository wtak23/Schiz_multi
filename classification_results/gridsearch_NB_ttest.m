...
if flag_scale
    outPath=[get_rootdir,'/classification_results/gridsearch_NB_ttest_zscaled.mat'];
else
    outPath=[get_rootdir,'/classification_results/gridsearch_NB_ttest.mat'];
end
