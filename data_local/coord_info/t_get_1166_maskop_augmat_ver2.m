...
%   is redundant since the augmentation matrix fills up half of the vectors by
...
load graph_info1166.mat adjmat coord
randn('state',0)
d=coord.nsamp;
p=d*(d-1)/2;
NSIZE=coord.NSIZE;
...
if fsave
    save augmat_mask1166ver2 b A timeStamp mFileName
end
%%