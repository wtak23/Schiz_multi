...
% mask_nii=tak_downsample_nii(mask_nii); %<- the part i removed from save_augmat_A_fullFOV.m
mask = mask_nii.img;
mask_vec=mask(:);
...
mFileName=mfilename;
save([get_rootdir,'/data_local/A_matrix_fullFOV_fullRes'],'A_full',...
