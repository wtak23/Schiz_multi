%% save_featureMatrix_sMRI_fullRes.m
% (05/08/2014)
%=========================================================================%
% save design matrix at full resolution
%=========================================================================%
%%
clear
purge
...
mFileName=mfilename;
save([get_rootdir,'/data_local/sMRI_design_censor_fullRes.mat'],'X','y','mFileName','timeStamp')
%%
% purge
% Xstd=zscore(X);
% figure,imagesc(X)
